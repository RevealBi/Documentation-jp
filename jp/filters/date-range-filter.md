...
<img src="images/add-new-dashboard-filter.png" alt="Add filter dropdown menu for a visualization" width="80%"/>

日付のダッシュボード フィルターを有効にすると、[表示形式バインディング式](connecting-dashboard-filters-visualization.html)で使用できるようになります。

<img src="images/dashboard-filter-date-range-menu.png" alt="Filter Date Range dialog" width="80%"/>
...
<img src="images/reveal-custom-date-range.png" alt="Custom Date Range calendar displayed" width="80%"/>
