...
ユーザー エクスペリエンスのエキスパートによって構築され、ビジネス ユーザー向けに設計された Reveal は、データ可視化の作成、表示、コラボレーターとの共有を簡単にします。使用しているデバイスに関係なく、シームレスで同一のエクスペリエンスを提供します: ウェブ、デスクトップ、iOS および Android。
...
<img src="dashboards/images/tooltips-totals.png" alt="Using tooltips and displaying totals in Reveal" width="80%"/>
