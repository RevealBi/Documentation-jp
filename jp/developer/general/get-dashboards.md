...
Reveal アプリの詳細については、[**オンライン デモ**](https://app.revealbi.io/)にアクセスするか、[**ヘルプ ドキュメント**](https://https://help.revealbi.io/jp/)を参照してください。
...
2.  **エクスポート オプションにアクセス**
    ...
    <img src="images/export_dashboards_sdk_web.png" alt="exporting format dialog " width="80%"/>
