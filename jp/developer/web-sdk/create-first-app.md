...
問題が発生した場合は、サーバー SDK - [**セットアップと構成**](../../general/setup-configuration-web.md) トピックを参照してください。
...
問題が発生した場合は、クライアント SDK [**セットアップと構成**](../../general/setup-configuration-web.md)トピックを参照してください。
