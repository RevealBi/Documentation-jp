...
#### Reveal アプリについて
Reveal アプリは、ダッシュボードを作成し、表示させ、およびチームと共有できるビジネス インテリジェンス ツールです。Reveal アプリの詳細については、[**オンラインデモ**](https://app.revealbi.io/)にアクセスするか、[**ヘルプ ドキュメント**](https://https://help.revealbi.io/jp/)を参照してください。
...
1.  [**データ ソースの置き換え**](replacing-data-sources.html)で説明したように、__IRVDataSourceProvider__ を実装し、__IRevealSdkContext__ の __DataSourceProvider__ プロパティとして返します。
