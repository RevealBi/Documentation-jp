...
<img src="images/ManufacturingDateAggregationChange_All.png" alt="ManufacturingDateAggregationChange\_All" class="responsive-img"/>

### 注文の書式

Y 軸に分数のない数値を表示するには、データ エディターの値プレース ホルダーにドロップされた **[注文]** フィールドの書式を変更する必要があります。それを選択し、**[フィルド設定]** メニューの **[書式]** で **[小数桁]** を [0] に変更します。

<img src="images/ManufacturingFormattingOrders_All.png" alt="ManufacturingFormattingOrders\_All" class="responsive-img"/>
