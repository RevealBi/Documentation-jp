...
>[!NOTE]
>[データ ソースを変更する](~/jp/datasources/changing-data-source-visualization.md)場合は、データ ソース名の横にあるオーバーフロー ボタンまたは[新しいデータ ソース](~/jp/datasources/overview.md)を選択する必要があります。表示形式を[複製](~/jp/data-visualizations/reusing-visualizations.md)し、作成時間を短縮することもできます。
...
3.  データ エディターで、**Employee** フィールドを [ラベル] に、**Labor** フィールドを [値] にドラッグアンドドロップします。
    ...
    <img src="images/DragDropManufacturingLaborcount_All.png" alt="DragDropManufacturingHeadcount\_All" class="responsive-img"/>
