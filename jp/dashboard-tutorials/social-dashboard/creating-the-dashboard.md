...
右上隅の [+] 記号を選択してから、[このセクション](~/jp/dashboard-tutorials/finance-dashboard/getting-started.html#sample-datasheet)で言及されたサンプル データシートを保存したデータ ソースを選択します。
...
<img src="images/SocialFirstVisualizationGrid_All.png" alt="SocialFirstVisualizationGrid\_All" width="80%"/>
