...
チュートリアルのはじめの[サンプル ダッシュボード](overview.html)に YTD Twitter Followers 表示形式を作成します。表示形式は[テキスト ゲージ](~/en/data-visualizations/gauge-views.html#text-gauge)を表示します。
...
<img src="images/SocialFirstDragDrop_All.png" alt="SocialFirstDragDrop\_All" width="80%"/>

最後に、Social Dashboard タイトルの横にある鉛筆を選択して、**表示形式のタイトルを YTD Twitter Followers に変更します**。

<img src="images/SocialWonOpportunitiesTitle_All.png" alt="SocialWonOpportunitiesTitle\_All" width="80%"/>

表示形式は以下のようになります。

<img src="images/SocialFirstVisualizationSample_All.png" alt="SocialFirstVisualizationSample\_All" width="80%"/>
