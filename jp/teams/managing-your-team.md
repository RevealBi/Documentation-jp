...
チームの[管理者](overview.html#members-roles-permissions)として、次のことができます:
...
特殊なタイプのチームとして、[組織リポジトリ](overview.html#組織リポジトリ) 管理は、Reveal のチーム管理の一般的なルールに対応しています。組織のリポジトリ管理に違いがある場合、それらはこのトピックで明示的に言及されます。
