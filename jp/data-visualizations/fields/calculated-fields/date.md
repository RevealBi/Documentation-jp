...
<table class="tg">
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm"> semester(datetime(1))
</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm"> fsemester(date(2015,11,1,11,33,48),1)
</span></td>
  </tr>
 <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm"> applytimezone(date(2015,12,1,10,33,38), ([Timezone]/24))
</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">currenttimezone()
</span></td>
  </tr>
   <tr>
  ...
  <tr>
    <td class="tg-cly1"><span style="font-weight:bold">サンプル</span>: <span class="gray-snippet-cstm">datetimefromunixts(0.001)
</span></td>
  </tr>
</table>
