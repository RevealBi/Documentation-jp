...
<table class="tg">
  ...
  <tr>
    <td class="tg-cly1" rowspan="2"><a href="https://help.revealbi.io/jp/logic.html#calc-fields-and-or">and</a>: <span class="gray-snippet-cstm">and</span> は 2 つの論理テストを実行します。<span style="font-weight:bold">論理テストは true の場合、1 を返します。1 つまた 2 つは false の場合、0 を返します。</span></td>
  ...
  <tr>
    <td class="tg-cly1" rowspan="2"><a href="https://help.revealbi.io/jp/logic.html#true-false"><span style="font-weight:bold">false</span></a>: <span class="gray-snippet-cstm">false</span> は論理値 の <span style="font-weight:bold">false</span> である 0 を返します。</td>
  ...
  <tr>
    <td class="tg-0lax" rowspan="2"><a href="https://help.revealbi.io/jp/logic.html#calc-fields-if"><span style="font-weight:bold">if</span></a>: <span class="gray-snippet-cstm">if</span> は論理テストを実行します。<span style="font-weight:bold">論理テストは true の場合、1 を返します。</span> <span style="font-weight:bold">論理テストは false の場合、0 を返します。</span></td>
  ...
  <tr>
    <td class="tg-0lax" rowspan="2"><a href="https://help.revealbi.io/jp/logic.html#calc-fields-not">not</a>: <span class="gray-snippet-cstm">not</span> は論理テストを実行します。<span style="font-weight:bold">論理テストは false の場合、1 を返します。論理テストは true の場合、0 を返します。</span></td>
  ...
  <tr>
    <td class="tg-0lax" rowspan="2"><a href="https://help.revealbi.io/jp/logic.html#calc-fields-and-or"><span style="font-weight:bold">or</span></a>: <span class="gray-snippet-cstm">or</span> は 2 つの論理テストを実行します (if ステートメント)。<span style="font-weight:bold">論理テスト の 1 つのいずれか true の場合、1 を返します。両方が false の場合、0 を返します。</span></td>
  ...
  <tr>
    <td class="tg-0lax" rowspan="2"><a href="https://help.revealbi.io/jp/logic.html#true-false">true</a>: <span class="gray-snippet-cstm">true</span> は論理値 の <span style="font-weight:bold">true</span> である 1 を返します。</td>
